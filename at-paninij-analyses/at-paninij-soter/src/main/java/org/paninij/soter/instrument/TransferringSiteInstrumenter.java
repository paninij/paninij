...
class TransferringSiteInstrumenter implements MethodExaminer
{
    ...
    private final Map<String, IdentitySet<TransferringSite>> sitesToInstrument;
     ...
     *                          method.
     */
    TransferringSiteInstrumenter(Map<String, IdentitySet<TransferringSite>> sitesToInstrument)
    {
    ...
    public void examineCode(MethodData methodData)
    {
        ...
        IdentitySet<TransferringSite> sites = sitesToInstrument.get(signature);
    ...
    private void instrumentAllSitesWithinMethod(IdentitySet<TransferringSite> sites,
