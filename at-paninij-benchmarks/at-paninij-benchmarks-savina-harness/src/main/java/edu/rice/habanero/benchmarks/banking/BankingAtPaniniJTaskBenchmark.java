...
public class BankingAtPaniniJTaskBenchmark
{
    static class BankingAtPaniniJTask extends Benchmark {
    ...
    public static void main(String[] args) {
        BenchmarkRunner.runBenchmark(args, new BankingAtPaniniJTask());
    }
}
