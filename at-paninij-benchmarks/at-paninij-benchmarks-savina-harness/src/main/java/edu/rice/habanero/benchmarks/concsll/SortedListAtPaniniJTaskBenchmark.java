...
public class SortedListAtPaniniJTaskBenchmark
{
    static class SortedListAtPaniniJTask extends Benchmark {
    ...
    public static void main(String[] args) {
        BenchmarkRunner.runBenchmark(args, new SortedListAtPaniniJTask());
    }
}
