...
public class NQueensAtPaniniJSerialBenchmark
{
    static class NQueensAtPaniniJSerial extends Benchmark {
    ...
    public static void main(String[] args) {
        BenchmarkRunner.runBenchmark(args, new NQueensAtPaniniJSerial());
    }
}
