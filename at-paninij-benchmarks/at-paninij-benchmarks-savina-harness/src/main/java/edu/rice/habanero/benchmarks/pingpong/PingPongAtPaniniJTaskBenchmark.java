...
public class PingPongAtPaniniJTaskBenchmark
{
    static class PingPongAtPaniniJTask extends Benchmark {
    ...
    public static void main(String[] args) {
        BenchmarkRunner.runBenchmark(args, new PingPongAtPaniniJTask());
    }
}
