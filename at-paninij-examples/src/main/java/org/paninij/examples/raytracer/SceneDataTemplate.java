...
@Capsule public class SceneDataTemplate {
    ...
    public void init() {
        ...
        things.add(new Sphere(Surfaces.shiny, new Vector(0, 1, 0), 1));
        things.add(new Sphere(Surfaces.shiny, new Vector(-1, 0.5, 1.5), .5));

        lights.add(new Light(new Vector(-2, 2.5, 0), new Color(0.49, 0.49, 0.49)));
        lights.add(new Light(new Vector(1.5, 2.5, 1.5), new Color(0.49, 0.49, 0.49)));
        lights.add(new Light(new Vector(1.5, 2.5, -1.5), new Color(0.49, 0.49, 0.49)));
        lights.add(new Light(new Vector(0, 3.5, 0), new Color(0.21, 0.21, 0.35)));
