...
public class ThreadRingAtPaniniJTaskBenchmark
{
    static class ThreadRingAtPaniniJTask extends Benchmark {
    ...
    public static void main(String[] args) {
        BenchmarkRunner.runBenchmark(args, new ThreadRingAtPaniniJTask());
    }
}
