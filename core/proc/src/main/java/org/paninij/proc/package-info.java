 ...
 * fully check a template if includes class definitions which haven't been
 ...
 * processor from some `StreamTemplate` signature template. With our
 * original annotation processor design, our annotation processor would,
 * during just one round of processing,
 *
 * <ul>
 *   <li>check `ConsoleTemplate`,</li>
 *   <li>check `StreamTemplate`,</li>
 *   <li>generate `Stream`, and</li>
 *   <li>generate `Console`.</li>
 * </ul>
 *
 * <p>This meant that when performing checks over `ConsoleTemplate`, the
 ...
 * `TypeKind.ERROR` values which appear in the fields of capsule templates
